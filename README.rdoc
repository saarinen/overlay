...
Rails engine that allows for overlaying external templates onto an existing Rails application.  Overlayed directories are prepended to the view path to allow ive overwriting of deployed templates.
...
* Overlay seperate directories in a single repo to specific places in your Rails application.
